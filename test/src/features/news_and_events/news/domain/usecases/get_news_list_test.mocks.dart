...
// in capoeirasport_project/test/src/features/news_and_events/news/domain/usecases/get_news_list_test.dart.
...
class MockNewsRepository extends _i1.Mock implements _i2.NewsRepository {
  ...
  @override
  _i3.Future<_i4.Result<List<_i5.News>, Exception>> getNewsList() =>
      (super.noSuchMethod(
        Invocation.method(
          #getNewsList,
          [],
        ),
        returnValue: _i3.Future<_i4.Result<List<_i5.News>, Exception>>.value(
            _i6.dummyValue<_i4.Result<List<_i5.News>, Exception>>(
          this,
          Invocation.method(
            #getNewsList,
            [],
      ...
      ) as _i3.Future<_i4.Result<List<_i5.News>, Exception>>);
}
